...
export class BatchesComponent {
    ...
    displayedColumns: string[] = ['currentStep', 'stepStatus', 'heronImport.progress','farmadati.progress','suppliers.progress','magento.progress'];
    displayedColumnsT: string[] = ['StartedAt', 'currentStep', 'stepStatus', 'magento', 'action'];
